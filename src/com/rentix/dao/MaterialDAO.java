...
import com.rentix.beans.Material;
 ...
 * 
 * @see com.rentix.beans.Material
 * @author MyEclipse Persistence Tools
 */

public class MaterialDAO extends HibernateDaoSupport {
	...
	public List<Material> findByExample(Material instance) {
		...
		try {
			List<Material> results = (List<Material>) getHibernateTemplate()
	...
	public List<Material> findByMaterialType(Object materialType) {
