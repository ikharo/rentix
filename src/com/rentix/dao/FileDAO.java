...
public class FileDAO extends HibernateDaoSupport {
	...
	public File findById(java.lang.Integer id) {
		...
		try {
			File instance = (File) getHibernateTemplate().get(
					"com.rentix.beans.File", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<File> findByExample(File instance) {
		...
		try {
			List<File> results = (List<File>) getHibernateTemplate()
	...
	public List<File> findByPath(Object path) {
